 ...
 * Reminders Model
 *
 * @property \App\Model\Table\TalksTable|\Cake\ORM\Association\BelongsTo $Talks
 *
 ...
 * @method \App\Model\Entity\Reminder|bool saveOrFail(\Cake\Datasource\EntityInterface $entity, $options = [])
...
class RemindersTable extends Table
{
    ...
    public function buildRules(RulesChecker $rules)
    {
        ...
        $rules->add($rules->existsIn(['talk_id'], 'Talks'));
